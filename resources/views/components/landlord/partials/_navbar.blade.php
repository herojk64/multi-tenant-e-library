...
<header x-data="{ open: false }" x-init="open = false"
    ...
    <h1 class="font-bold text-2xl md:text-3xl text-gray-500 delay-100">
        <a href="{{route('landlord.home')}}" class="">
    ...
    <nav class="hidden md:flex md:gap-3">
        <ul class="flex gap-3">
            <li>
                <x-landlord.partials._navlink :route="route('landlord.home')">Home</x-landlord.partials._navlink>
            </li>
            <li>
                <x-landlord.partials._navlink :route="route('landlord.services')">Services</x-landlord.partials._navlink>
            </li>
            <li>
                <x-landlord.partials._navlink :route="route('landlord.about')">About Us</x-landlord.partials._navlink>
            </li>
            @guest
                <li>
                    <button class="">
                        <a href="{{route('landlord.login')}}" class="block border border-blue-500 hover:border-blue-600
                ...
                <li>
                    <button class="">
                        <a href="{{route('landlord.register')}}" class="block border border-blue-500 hover:border-blue-600
            ...
            @auth
                <li x-data="{ dropdownOpen: false }">
                    ...
                    <div x-cloak x-show="dropdownOpen" @click.away="dropdownOpen = false" class="absolute right-0 mt-2 w-48 bg-white border border-gray-200 shadow-lg rounded-lg overflow-hidden z-20">
                        <ul>
                            @can('landlord.admin')
                            <li><a href="{{route('filament.admin.pages.dashboard')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 text-center">Admin Dashboard</a></li>
                            @endcan
                                <li><a href="{{route('landlord.profile')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 text-center">Profile</a></li>
                            <li><a href="{{route('landlord.dashboard')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 text-center">Dashboard</a></li>
                            <li>
                                <form action="{{route('landlord.logout')}}" method="post" class="w-full">
                                    @csrf
                    ...
                    @guest
                        <li>
                            <x-landlord.partials._navlink
                                ...
                                class="text-center border-0 hover:border-b-transparent active:border-b-transparent border-b-transparent text-white bg-blue-500 rounded active:text-white active:bg-blue-500 hover:text-white hover:border-b-0"
                            >Login
                            </x-landlord.partials._navlink>
                        </li>
                        <li>
                            <x-landlord.partials._navlink
                                :route="route('landlord.register')"
                                class="text-center hover:border-b-blue-500 hover:border-b-1 hover:text-blue-500 transition delay-100 ease-in-out border border-blue-500 active:border-blue-300 active:bg-white hover:border-b-1 active:text-blue-300 rounded text-blue-500"
                            >Sign Up
                            </x-landlord.partials._navlink>
                        </li>
                    @endguest
                        ...
                        <li x-data="{ dropdownOpen: false }">
                            ...
                            <div x-cloak x-show="dropdownOpen" @click.away="dropdownOpen = false" class="mt-2 w-full bg-gray-100 border border-gray-100">
                                <ul class="space-y-4">
                                    ...
                                    @endcan
                                    <li><a href="{{route('landlord.profile')}}" class="block px-4 py-2 bg-white text-center active:bg-gray-100">Profile</a></li>
                                    <li><a href="{{route('landlord.dashboard')}}" class="block px-4 py-2 bg-white text-center active:bg-gray-100">Dashboard</a></li>
                                    <li>
                                        <form action="{{route('landlord.logout')}}" method="post" class="w-full">
                                            @csrf
