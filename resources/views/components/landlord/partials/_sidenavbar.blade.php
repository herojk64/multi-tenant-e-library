<!-- Sidebar -->
        <aside class="bg-white py-2 px-2">
            <nav>
                <ul>
                    <li>
                        <a href="{{route('landlord.profile')}}" class="flex items-center gap-2 px-4 py-2 mb-2 text-gray-700 hover:bg-gray-200 rounded {{url()->current() === route('landlord.profile')?'bg-gray-200':''}}">
