...
<a
    ...
    $attributes->merge(
            [
            'class'=>"block cursor-pointer text-gray-500 hover:text-gray-800 py-2 px-3 hvr-underline-from-center transition delay-75 ease-in-out active:bg-gray-200 active:bg-opacity-75".
            " ".
